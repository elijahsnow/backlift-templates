/*
 * Martin Kou's SafeHTML fix for mobile safari innerHTML problems. Provides
 * a jQuery plugin that replaces .html() with a version that appends DOM nodes
 * rather than using the innerHTML property. Also exposes the htmlToFragment
 * function. Original source:
 * http://martinkou.blogspot.com/2011/05/alternative-workaround-for-mobile.html
 * 
 * Includes John Resig's HTML parser, Mozilla Public License
 *
 * Adopted for use by Backlift. Adds htmlToFragment and HTMLParser to the 
 * Backlift namespace. If $ variable exists at global scope, adds $.safeHtml()
 * andreplaces $.html() with $.safeHtml().
 */
...
(function() {
  ...
  /*
   * Martin Kou's SafeHTML fix for mobile safari innerHTML problems
   * http://martinkou.blogspot.com/2011/05/alternative-workaround-for-mobile.html
   */
